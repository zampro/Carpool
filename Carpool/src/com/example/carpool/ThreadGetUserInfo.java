...
//CLASS FOR RECEIVING USER-INFO FROM DATABASE

public class ThreadGetUserInfo implements Runnable {
	...
	public String username = "";
		...
		// Constructor
		public ThreadGetUserInfo(Handler UI, String username) {
			this.ui = UI;
			try {
	...
	public void run() {
		...
		String url1 = "http://users.metropolia.fi/~samposi/carpool/getUserInfo.php?username="+username;
		

		// Calls method for receiving JSON
		String readJSON = getJSON(url1);
